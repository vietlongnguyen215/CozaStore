<?php
	trait CartModel{		
		...
		public function cartCheckOut(){
			...
			$query = $conn->prepare("insert into orders_project set customer_id=:customer_id, create_at=now()");
			...
			foreach($_SESSION["cart"] as $product){
				$query = $conn->prepare("insert into orderdetails_project set order_id=:order_id, product_id=:product_id, price=:price, number=:number");
