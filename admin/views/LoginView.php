                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="p-5">
                                    ...
                                    <form class="user" method="post" action="index.php?controller=login&action=login">
                                        ...
                                        <input type="submit" name="Login" value="Đăng nhập" class="btn btn-google btn-user btn-block">
                                        <hr>
